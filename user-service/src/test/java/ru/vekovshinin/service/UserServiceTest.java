...
public class UserServiceTest {
  ...
  void findById() {
    ...
    User result = service.findById(entity.getId());
  ...
  @Test
  void save_ExistsByUsername() {
    doThrow(ValidationException.UserExists.class).when(validator).validate(entity);

    assertThrows(ValidationException.UserExists.class, () -> service.save(entity));
  }
